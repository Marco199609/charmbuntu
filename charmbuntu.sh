...
echo "Copying kernel..."
#cheating and assuming we are on /dev/mmcblk1
dd if=/dev/mmcblk0p1 of=$kernelpart
...
echo "deb http://ports.ubuntu.com/ubuntu-ports/ bionic main universe multiverse restricted contrib non-free" > /mnt/etc/apt/sources.list
